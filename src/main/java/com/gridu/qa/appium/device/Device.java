 ...
 */
package com.gridu.qa.appium.device;

import static com.gridu.qa.appium.config.enums.AutomationType.APPIUM;
import static com.gridu.qa.appium.config.enums.PlatformType.ANDROID;
import static com.gridu.qa.appium.utils.CapabilityUtils.setCapability;
import static com.gridu.qa.appium.utils.ScreenRecorder.getVideoStreamArgs;
import static com.gridu.qa.appium.utils.ScreenRecorder.saveRecording;
...
import com.gridu.qa.appium.checker.ServerChecker;
import com.gridu.qa.appium.config.AppiumSetting;
import com.gridu.qa.appium.config.device.DeviceSetting;
import com.gridu.qa.appium.config.device.OtherSetting;
import com.gridu.qa.appium.config.device.RecordSetting;
import com.gridu.qa.appium.config.device.VideoStreamSetting;
import com.gridu.qa.appium.config.device.android.AdbSetting;
import com.gridu.qa.appium.config.device.android.AndroidAppSetting;
import com.gridu.qa.appium.config.device.android.AndroidDeviceSetting;
import com.gridu.qa.appium.config.device.android.AndroidWebSetting;
import com.gridu.qa.appium.config.device.android.AvdSetting;
import com.gridu.qa.appium.config.device.android.WebOptions;
import com.gridu.qa.appium.config.device.ios.IOSAppSetting;
import com.gridu.qa.appium.config.device.ios.IOSDeviceSetting;
import com.gridu.qa.appium.config.device.ios.IOSWebSetting;
import com.gridu.qa.appium.config.device.ios.WDASetting;
...
import com.gridu.qa.appium.error.DeviceDriverDefaultWaitError;
import com.gridu.qa.appium.error.DeviceDriverInitializationFailedError;
import com.gridu.qa.appium.error.DeviceDriverNotStartingError;
import com.gridu.qa.appium.error.DeviceDriverNotStoppingError;
...
import com.gridu.qa.appium.constants.ErrorMessage;
...
public abstract class Device<D extends AppiumDriver<MobileElement>, T extends TouchAction<T>> {
    ...
    private void quitApp () {
        ...
        try {
            ...
            fail (AppiumServerStoppedError.class, ErrorMessage.SERVER_STOPPED, e);
